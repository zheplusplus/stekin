...
TEST_F(ClauseBuilderTest, AcceptorStackNext)
{
    ...
    stack0.nextStmt(0, std::move(
                util::mkptr(new grammar::VarDef(item_pos, "ruby", std::move(
                            util::mkptr(new grammar::Reference(item_pos, "emerald")))))));
    stack0.nextStmt(0, std::move(
                util::mkptr(new grammar::VarDef(item_pos, "topiz", std::move(
                            util::mkptr(new grammar::Reference(item_pos, "ruby")))))));
    stack0.nextFunc(0, std::move(util::mkptr(new grammar::Function(
                                                        item_pos
                                                      , "skull"
    ...
    block0.compile(std::move(mkfilter()))->deliver().compile(nulscope);
    ...
    stack0.nextFunc(4, std::move(util::mkptr(new grammar::Function(
                                                        err_pos1
                                                      , "ith"
...
TEST_F(ClauseBuilderTest, AcceptorStackAdd)
{
    ...
    stack0.add(0, std::move(util::mkmptr(new grammar::FunctionAcceptor(
                                                            acc_pos
                                                          , "witherstring"
                                                          , std::vector<std::string>()))));
    stack0.nextStmt(1, std::move(
                util::mkptr(new grammar::VarDef(item_pos, "cedar_bow", std::move(
    ...
    stack1.add(0, std::move(util::mkmptr(new grammar::FunctionAcceptor(
                                                            acc_pos
                                                          , "witherstring"
                                                          , std::vector<std::string>()))));
    stack1.nextStmt(1, std::move(
                util::mkptr(new grammar::VarDef(item_pos, "cedar_bow", std::move(
                            util::mkptr(new grammar::Reference(item_pos, "kuko_shakaku"))))))); 
    stack1.nextStmt(0, std::move(
                util::mkptr(new grammar::Arithmetics(item_pos, std::move(
                            util::mkptr(new grammar::Reference(item_pos, "eaglehorn")))))));
    stack1.nextStmt(1, std::move(
                util::mkptr(new grammar::Arithmetics(item_pos, std::move(
...
TEST_F(ClauseBuilderTest, ClauseBuilder)
{
    ...
    builder0.addIf(0, std::move(util::mkptr(new grammar::BoolLiteral(item_pos0, true))));
        builder0.addVarDef(1, "wind_force", std::move(
                                    util::mkptr(new grammar::IntLiteral(item_pos1, "13571"))));
        builder0.addIfnot(1, std::move(
                                    util::mkptr(new grammar::Reference(item_pos2, "raven_claw"))));
            builder0.addReturn(2, std::move(
                                    util::mkptr(new grammar::FloatLiteral(item_pos0, "0.000123"))));
        builder0.addReturnNothing(1, item_pos1);
    builder0.addElse(0, item_pos2);
        builder0.addIfnot(1, std::move(
                                    util::mkptr(new grammar::Reference(item_pos2, "cliffkiller"))));
            builder0.addIfnot(2, std::move(
                                    util::mkptr(new grammar::Reference(item_pos0, "skystrike"))));
    ...
    builder1.addIf(0, std::move(util::mkptr(new grammar::BoolLiteral(item_pos0, true))));
    builder1.addVarDef(0, "wind_force", std::move(
                                    util::mkptr(new grammar::IntLiteral(item_pos1, "13571"))));
