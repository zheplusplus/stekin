#ifndef __STACKENING_SYMBOL_TABLE_INSTANCE_SPACE_H__ 
#define __STACKENING_SYMBOL_TABLE_INSTANCE_SPACE_H__
...
#endif /* __STACKENING_SYMBOL_TABLE_INSTANCE_SPACE_H__ */
