...
namespace proto {
    ...
    public:
        ...
        util::sptr<Expression const> makeInt(misc::position const& pos, mpz_class const& value) const;
        util::sptr<Expression const> makeFloat(misc::position const& pos, mpf_class const& value) const;
        virtual util::sptr<Expression const> makeRef(misc::position const& pos, std::string const& name) = 0;
        virtual util::sptr<Expression const> makeCall(misc::position const& pos
        ...
        util::sptr<Expression const> makeDisj(misc::position const& pos
                                            , util::sptr<Expression const> lhs
                                            , util::sptr<Expression const> rhs) const;
        util::sptr<Expression const> makeNega(misc::position const& pos, util::sptr<Expression const> rhs) const;
    public:
